...
module Sys(
  ...
  reg         r_valid;
  reg  [31:0] r_addr;
  wire        _GEN = _m_bootloader_io_b_mem_addr < 16'h200;
  ...
  wire        _GEN_5 = _m_core_io_b_mem_addr < 16'h200;
  ...
  Ram m_ram (
    ...
    .io_b_port_addr
      (_m_bootloader_io_o_bl
         ? _m_bootloader_io_b_mem_addr[10:2]
         : _m_core_io_b_mem_addr[10:2]),
    .io_b_port_wen
      (_m_bootloader_io_o_bl
